...
export default function HomeScreen() {
  ...
  return (
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      ...
      />
      <Section
        title="Promoção Fim de ano Nexus"
      ...
      <SpecialCard
        ...
        cor="#D32F2F"
        imagem={require("../screens/assets/bannermario.png")}
      />
      <SpecialCard
        title="Confira nossa seleção PlayStation!"
        cor="#1976D2"
        imagem={require("../screens/assets/bannerkratos.png")}
      />
      <SpecialCard
        title="Confira nossa seleção Xbox!"
        cor="#388E3C"
        imagem={require("../screens/assets/bannerhalo.png")}
      />
      ...
      <TouchableOpacity style={styles.botao} onPress={handleVerCategorias}>
        <Text style={styles.botaoTexto}>
          Ver todas as categorias de produtos
        </Text>
      </TouchableOpacity>
    </ScrollView>
  );
